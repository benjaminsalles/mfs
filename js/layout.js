    function ln(ln) {
        ...
        if (ln == "ln1") {
            ...
            document.getElementById("nav2b").innerHTML = "dashboard";
            document.getElementById("rnln").innerHTML = "<ul><li>&nbsp;</li></ul>";
            showCTNT(11);
        } else if (ln == "ln2") {
            ...
            document.getElementById("nav2b").innerHTML = "accounts";
            document.getElementById("rnln").innerHTML = "<ul><li><i class='fa fa-filter' onclick='showCTNT(0);'></i><li><i class='fa fa-th-large' onclick='showCTNT(21);'></i></li><li><i class='fa fa-list' onclick='showCTNT(22);'></i></li><li><i class='fa fa-map' onclick='showCTNT(23);'></i></li><li><i class='fa fa-connectdevelop' onclick='showCTNT(24);'></i></li></ul>";
            showCTNT(21);
        } else if (ln == "ln3") {
            ...
            document.getElementById("nav2b").innerHTML = "notes";
            document.getElementById("rnln").innerHTML = "<ul><li><i class='fa fa-filter' onclick='showCTNT(0);'></i><li><li><i class='fa fa-th-large' onclick='showCTNT(31);'></i></li><li><i class='fa fa-list' onclick='showCTNT(32);'></i></li></ul>";
            showCTNT(31);
        } else if (ln == "ln4") {
            ...
            document.getElementById("nav2b").innerHTML = "presentation";
            document.getElementById("rnln").innerHTML = "<ul><li>&nbsp;</li></ul>";
            showCTNT(41);
        }
    }
    ...
    for (i = 1; i <= companies.length; i++) {
        //alert(companies[i][5]);
        document.getElementById("content_21").innerHTML = document.getElementById("content_21").innerHTML + "<div class='companyGrid col-xs-12 col-sm-6 col-md-4 col-lg-4'><div class='companyGrid_logo' style='background-image:url(img/" + companies[i][5] + "); margin-top:10px;'></div><div class='companyGrid_mid'>" + companies[i][6] + " and " + companies[i][7] + "</div><div class='companyGrid_info'><p>" + companies[i][0] + "</p><p>" + companies[i][1] + "<br>" + companies[i][2] + "<br>Email <a href=''>" + companies[i][3] + "</a><br>Phone " + companies[i][4] + "</p><p><a href=''>Contact Info</a></p></div></div>";

        document.getElementById("content_22").innerHTML = document.getElementById("content_22").innerHTML + "<div class='row mfsRow'><div class='col-xs-4 col-sm-4 col-md-2 col-lg-2'><div class='companyGrid_logo' style='background-image:url(img/" + companies[i][5] + ");'></div></div><div class='col-xs-8 col-sm-8 col-md-3 col-lg-3>" + companies[i][0] + "<p>" + companies[i][1] + "<br>" + companies[i][2] + "<br>Email <a href=''>" + companies[i][3] + "</a><br>Phone " + companies[i][4] + "</p><p><a href=''>Contact Info</a></div><div class='col-xs-4 col-sm-4 col-md-2 col-lg-2 mfsBubble'>Actual<br>" + companies[i][6] + "<br><span>+15% vs. YAG</span></div><div class='col-xs-4 col-sm-4 col-md-2 col-lg-2 mfsBubble'>Pipeline<br>" + companies[i][7] + "<br><span>+15% vs. YAG</span></div><div class='col-xs-4 col-sm-4 col-md-2 col-lg-2 mfsBubble'>Opportunity<br>" + companies[i][8] + "</div><div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 mfsRowNotes'>" + companies[i][9] + "</div></div>";
        document.getElementById("content_31").innerHTML = document.getElementById("content_31").innerHTML + "<div class='companyGrid notePadding col-xs-12 col-sm-6 col-md-4 col-lg-4'><table><tr><td><span>" + notes[i][0] + "</span></td><td><i class='fa fa-star' style='color:" + notes[i][4] + "'></i></td></tr><tr><td colspan='2'> <span>Created by:</span> " + notes[i][1] + "<br> <span>Created on:</span> " + notes[i][2] + "<br> <span>Type:</span> " + notes[i][3] + "</td></tr><tr><td colspan='2'>" + notes[i][5] + "</td></tr></table></div>";
        document.getElementById("content_32").innerHTML = document.getElementById("content_32").innerHTML + "<div class='companyRow noteRow col-xs-12 col-sm-12 col-md-12 col-lg-12'><span>" + notes[i][0] + "</span> <i class='fa fa-star' style='color:" + notes[i][4] + "'></i><p><span>Created by:</span> " + notes[i][1] + " | <span>Created on:</span> " + notes[i][2] + " | <span>Updated on:</span> " + notes[i][2] + " | <span>Most Recent Note:</span> " + notes[i][2] + " | <span>Type:</span> " + notes[i][3] + "</p><p>" + notes[i][5] + "</p></div>";
    }
